...
_w['_sydConvTranslation'] = {
  ...
  welcomeMessageItemContent1: '帮我写一段关于今天吃到的好吃的松茸鸡煲的广告',
  welcomeMessageItemContent2: '2023年，如果我喜欢AI希望以后的工作很赚钱，应该报考什么专业?',
  welcomeMessageItemContent3: '帮我搜索今天最火的关于chatgpt的新闻，并翻译为中文，给出对应链接',
  welcomeMessageItemTitle1: '🧐 提出复杂创作任务',
  welcomeMessageItemTitle2: '🙌获取快速评估',
  welcomeMessageItemTitle3: '🎨 获得创意灵感',
  welcomeMessageItemLabel4: '更多创意中的新增功能：',
  warmWelcomeTitle: '欢迎使用摘摘的假的必应',
  welcomeSubtitleText: 'GPT站点为：beta.zhai-zhai.com',
