...
_w['_sydConvConfig'] = {
  ...
  hideSydFSC: false,
  sydOptionSets: 'dsblhlthcrd,rweasgv2',
  sydBalOpts: '',
  sydCrtOpts: 'dv3latencyv4',
  sydPrcOpts: 'dv3latencyv4',
  voiceSrOptions: '',
  ...
  Syd2TFlights: '',
  sydIDs:
    'upsellmodcf,winmuid2tf,wrapalledgcf,newmmaalt,newmmadesign,pref3,winlongmsg2tf,sydtransl,sydconfigoptc,nodupeventsc,cssconvdesk,adssqovr-prod,530pstho,321slocs0,418dhlth,606rlv4,529rwea,524vidansgs0',
  ...
  fromNoResults: false,
  sydTestCacheMsg: '',
  traceId: '64831dbf22ca4450a1adcdec1d613488',
  extraSappOptions: '',
  extraEdgeOptions: '',
  enableSydMic: false,
  carouselQueries: '',
  ...
  enableMobileShareAnchorBottom: false,
...
_w['_sydConvTranslation'] = {
  ...
  messagePrivacyLabel: '无法在组织外部看到工作内容和聊天',
  letsChat: '我们聊天吧',
  pause: '暂停',
  play: '开始游戏',
  ...
  metaInternalImageLoaderMessage: '分析图像: 人脸可能模糊以保护隐私',
  ...
  newUserGreet: '感谢你加入！我是必应，我准备和你一起学习。我可以给你几乎任何问题的答案— 问我一个深刻的想法或一个简单的问题或介于两者之间的问题。',
  newUserSugg1: '搜索网页',
  newUserSugg2: '玩剪刀石头布',
  newUserSugg3: '搜索电影',
  repeatUserGreet: '很高兴你回来了！无论你想说什幺，我都持开放态度。我能为你做什么？',
  repeatUserSugg1: '玩井字游戏',
  repeatUserSugg2: '撰写论文',
  ...
  sydneySapphireGPT4Greet: '很好!ChatGPT-4 是 🎉。在发挥创意的同时，响应速度可能会变慢。你的想法是什么?',
  ...
  exportOnlineWordButtonLabel: '在浏览器中打开',
