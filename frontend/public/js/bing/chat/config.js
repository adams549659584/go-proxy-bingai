...
_w['_sydConvConfig'] = {
  ...
  hideSydFSC: false,
  sydOptionSets: 'uquopt,enpcktrk',
  sydBalOpts: '',
  sydCrtOpts: '',
  sydPrcOpts: 'ppofp4fp8',
  voiceSrOptions: 'cdxclidcf',
  sydBalExtraOpts: 'saharagenconv5',
  sydCrtExtraOpts: 'clgalileo,gencontentv3',
  sydPrcExtraOpts: 'clgalileo,gencontentv3',
  sydIDs: 'tts3,0712newas,wrapuxslimc,kcimgov2cf,0731ziv2,707enpcktrks0,812fluxv1pcs0a,0518logoss0,tvcf',
...
_w['_sydConvTranslation'] = {
  ...
  seeLess: '查看更少',
  raiSuggestions: '这是什么?',
  actionBarFileUploadButtonAriaLabel: 'Search in a file',
  ...
  newUserGreet: '你好，我是必应。我使用 AI 为您提供网络搜索、内容创作、娱乐和对话。我还可以生成诗歌、故事、代码和其他类型的内容。你对什么感到好奇?',
  newUserSugg1: '玩小游戏',
  newUserSugg2: '玩小游戏',
  newUserSugg3: '创作歌曲',
  repeatUserGreet: '欢迎回来。我很高兴能与你分享更多内容。今天要创建什么?',
  repeatUserSugg1: '撰写论文',
  repeatUserSugg2: '生成故事',
  repeatUserSugg3: '给我一个绕口令',
  ...
  balancedSugg3: '给我个周末度假的主意',
  preciseSugg1: '跟我说说第 22 任总统',
  preciseSugg2: '教我怎么解魔方',
  ...
  actionBarNewlineTooltip: 'Use Shift+Enter to create line breaks for longer messages',
  notiReConnect: '出错了。',
  notiChatEnd: '聊天主题已结束。',
  ...
  fileUploadFlyoutTitle: 'Add a text file',
  fileUploadFlyoutUploadButtonLabel: 'Upload from this device',
  fileUploadGenericErrorMessage: 'Sorry - It looks like your uploads failed. Please try again',
  preview: '预览',
